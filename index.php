            ...
            <li class="topic">
              <div class="row">
                <div class="col-md-2">
                  ...
                  ?>
                 <!-- <img src="https://www.gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50" alt="" class="avater pull-left"> -->
                </div>
                <div class="col-md-10">
                  <div class="topic-content">
                    <h3><a href="topic.php?topicid=<?php echo $topic['id'] ; ?>"><?php echo $topic['title'] ; ?></a></h3>
                    <div class="topic-info">
                      <a href="topics.php?catid=<?php echo $topic['category_id']; ?>">
                        <?php 
                      ...
                      <a href="profile.php?topicid=<?php echo $topic['id']; ?>">
                        <?php 
